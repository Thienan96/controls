/* From: https://github.com/dmacfarlane/angular-mentions/blob/master/projects/angular-mentions/src/lib/caret-coords.ts */
...
export function getCaretCoordinates(element, position, options): {top: number, left: number} {
    if (!isBrowser) {
